...
export default {
    ...
    mounted() {
        ...
        this.passignThenAccessToken(access_token);
    ...
    computed:{
        getAUth(){
            return  this.$store.getters.getAuthVisaAccesstoken;
        }
    },
    methods:{
         logout(){
        ...
        passignThenAccessToken(access_token){
         
           this.$store.dispatch('passignThenAccessTokenAction',access_token);
        }
    },
    components:{
        compSidebar
